...
| What to own | Conviction = (opportunity − 50) × (1 + gap/50) × long-term theme conviction (0.7–1.3×) × Human Futures Engine ranking (0.85–1.35×, headwind names 0.8×) × attention flags (not-priced +15%, crowded −25%) × macro fit | this system |
